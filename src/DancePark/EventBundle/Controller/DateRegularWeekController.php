...
class DateRegularWeekController extends Controller
{
     ...
     *
     * @Route("/", name="admin_dete_regular_week")
     * @Method("GET")
     * @Template()
     */
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EventBundle:DateRegularWeek')->findAll();
     ...
     *
     * @Route("/", name="admin_dete_regular_week_create")
     * @Method("POST")
     * @Template("EventBundle:DateRegularWeek:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_dete_regular_week_show', array('id' => $entity->getId())));
        }
     ...
     *
     * @Route("/new", name="admin_dete_regular_week_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_dete_regular_week_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EventBundle:DateRegularWeek')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="admin_dete_regular_week_edit")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_dete_regular_week_update")
     * @Method("PUT")
     * @Template("EventBundle:DateRegularWeek:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_dete_regular_week_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="admin_dete_regular_week_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_dete_regular_week'));
    }
