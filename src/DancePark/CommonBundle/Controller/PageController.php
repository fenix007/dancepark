...
use DancePark\CommonBundle\Entity\Page;
use DancePark\CommonBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CommonBundle:Page')->findAll();
     ...
     * @Method("POST")
     * @Template("CommonBundle:Page:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CommonBundle:Page')->find($id);
     ...
     * @Method("PUT")
     * @Template("CommonBundle:Page:edit.html.twig")
     */
